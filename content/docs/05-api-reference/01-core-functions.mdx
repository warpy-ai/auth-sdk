  ...
  return (
    ...
    >
      <div>
        ...
        <p>
          @auth-sdk/core provides several core functions for authentication. 
        ...
        <ApiMethod
          ...
          example={`import { authenticate, google } from '@auth-sdk/core';
...
if (result.session) {
  ...
  return Response.redirect(result.redirectUrl);
        ...
        <ApiMethod
          ...
          example={`import { getSession } from '@auth-sdk/core';
...
export async function GET(request: Request) {
  ...
  return Response.json({ user: session.user });
        ...
        <ApiMethod
          ...
          example={`import { signOut } from '@auth-sdk/core';
...
export async function POST(request: Request) {
  ...
  return Response.json({ success: true });
        ...
        <ApiMethod
          ...
          returns="Promise<Session | null>"
          example={`import { verifyAgentToken } from '@auth-sdk/core';
...
export async function GET(request: Request) {
  ...
  return Response.json({ data: 'Protected data' });
        ...
        <p>
          Core types used throughout @auth-sdk/core:
        </p>
