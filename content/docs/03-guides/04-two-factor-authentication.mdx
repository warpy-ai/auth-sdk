...
export const metadata = {
  ...
  description: 'Implementing 2FA with email verification codes',
};
...
export default function TwoFactorAuthentication() {
  return (
    <DocsLayout
      ...
      description="Implementing 2FA with email verification codes"
      prevPage={{ title: 'Node.js HTTP Adapter', href: '/docs/guides/nodejs-adapter' }}
      nextPage={{ title: 'CAPTCHA Integration', href: '/docs/guides/captcha-integration' }}
    >
      <div>
        <h2>Two-Factor Email Authentication</h2>
  ...
  switch (result.error) {
    ...
    default:
      ...
      break;
        ...
        <ul>
          <li><a href="https://github.com/warpy-ai/auth-sdk/tree/main/examples/nextjs-email-code" target="_blank">Next.js 2FA Example</a> - Complete working example</li>
          <li><a href="/docs/providers/two-factor-email">Two-Factor Email Provider</a> - Provider-specific documentation</li>
        </ul>
      </div>
    </DocsLayout>
  );
