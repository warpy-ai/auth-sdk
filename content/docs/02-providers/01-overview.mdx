...
export const metadata = {
  ...
  description: 'Understanding the provider architecture in @auth-sdk/core.',
};
  ...
  return (
    ...
    >
      <div>
        ...
        <p>
          Providers in @auth-sdk/core are factory functions that return configuration objects 
        ...
        <p>
          @auth-sdk/core comes with several built-in providers:
        </p>
...
const authConfig = {
  ...
  provider: googleProvider, // or emailProvider
        ...
        <CodeBlock language="typescript">
{`import { OAuthProvider } from '@auth-sdk/core';
