  ...
  return (
    ...
    >
      <div>
        ...
        <p>
          This example demonstrates a complete Next.js 16 application with @auth-sdk/core, 
    ...
    return Response.json(
      ...
      { status: 500 }
        ...
        <Callout type="success" title="Example Complete">
          You now have a complete Next.js application with authentication using @auth-sdk/core. 
