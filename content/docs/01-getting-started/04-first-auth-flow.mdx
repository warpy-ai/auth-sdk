    ...
    >
      <div>
        ...
        <p>
          ...
          with @auth-sdk/core, including protected routes and session management.
        </p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Example
          ...
          code={`import { getSession } from "@auth-sdk/core";
...
{`npm run dev`}
        ...
        <Callout type="success" title="Congratulations!">
          You've successfully implemented a complete authentication flow with @auth-sdk/core. 
