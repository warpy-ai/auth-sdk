...
export const metadata = {
  ...
  description: 'Install @warpy-auth-sdk/core and set up your first authentication flow in minutes.',
};
...
import { createMCPTools } from '@warpy-auth-sdk/core/mcp';`}
        ...
        <p>
          @warpy-auth-sdk/core is built with TypeScript and includes comprehensive type definitions. 
