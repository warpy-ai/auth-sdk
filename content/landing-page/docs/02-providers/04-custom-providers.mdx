...
export const metadata = {
  ...
  description: 'Building custom authentication providers for @warpy-auth-sdk/core.',
};
...
export default function CustomProviders() {
  return (
    ...
    >
      <div>
        ...
        <p>
          While @warpy-auth-sdk/core comes with built-in providers for popular services, you might need 
  ...
  authenticate: (request: Request) => Promise<AuthenticateResult>;
        ...
        <Example
          ...
          code={`import { OAuthProvider } from '@warpy-auth-sdk/core';
  ...
  },
  {
    ...
    errorRedirect: '/login',
        ...
        <Example
          ...
          code={`import { EmailProvider } from '@warpy-auth-sdk/core';
    ...
    async verifyToken(token: string) {
      ...
      try {
        ...
        <Example
          ...
          code={`import { CustomProvider } from '@warpy-auth-sdk/core';
  ...
  return customOAuth({
    ...
    scope: ['identify', 'email'],
        ...
        <Callout type="success" title="Custom Providers Complete">
          You've learned how to create custom providers for @warpy-auth-sdk/core. 
