    ...
    >
      <div>
        ...
        <p>
          ...
          This guide walks you through setting up Google OAuth with @warpy-auth-sdk/core.
        </p>
        ...
        <ol>
          ...
          <li>Enable "People API" (and any other APIs you need)</li>
        </ol>
...
GOOGLE_REDIRECT_URI=http://localhost:3000/api/auth/callback/google`}
        ...
        <Example
          ...
          code={`import { google } from '@warpy-auth-sdk/core';
...
export function proxy(request: NextRequest) {
  ...
  return NextResponse.next();
        ...
        <Callout type="success" title="Google OAuth Complete">
          You've successfully set up Google OAuth with @warpy-auth-sdk/core. 
